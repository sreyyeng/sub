...
Write-Output 'Copying - codecs\Avisynth (skipped in AIbeta build)'
# AviSynth+ bundling disabled — its release asset layout changed and the
# auto-fetcher in win-installer-setup.ps1 no longer finds the right files.
# FFMS2 (Aegisub's default video provider) covers mp4/mkv/avi etc. without it.
