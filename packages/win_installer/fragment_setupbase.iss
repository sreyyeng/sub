...
[Setup]
AppName=Aegisub AIbeta
AppVerName=Aegisub AIbeta ({#BUILD_GIT_VERSION_STRING})
AppVersion={#INSTALLER_VERSION}
AppPublisher=Aegisub Team (AIbeta build)
...
OutputBaseFilename=Aegisub-AIbeta-{#BUILD_GIT_VERSION_STRING}
VersionInfoDescription=Aegisub AIbeta ({#BUILD_GIT_VERSION_STRING})
